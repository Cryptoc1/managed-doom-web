...
public sealed record class UIVersion : IComparable<UIVersion>
{
    /// <summary> A reference to the current version of the application. </summary>
    public static readonly UIVersion Current = FromAssembly( typeof( UIVersion ).Assembly );
    ...
    public UIVersion( int major, int minor, int patch, float? candidate = null, string? metadata = null )
    {
        Major = major;
        Minor = minor;
        Patch = patch;
    ...
    /// <inheritdoc/>
    public int CompareTo( UIVersion? other )
    {
        if( other is null )
        {
            return 1;
    ...
    public static UIVersion FromAssembly( Assembly assembly )
    {
    ...
    public static UIVersion Parse( string version )
    {
    ...
    /// <inheritdoc/>
    public static implicit operator string( UIVersion version ) => version.ToString();

    /// <inheritdoc/>
    public static bool operator <( UIVersion left, UIVersion right ) => left.CompareTo( right ) < 0;
